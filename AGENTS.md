...
- **localizationProvider Import Hatası:** Derleme sırasında "Error when reading 'lib/core/localization/language_provider.dart'" hatası alırsanız, bu dosyanın yeri lib/core/providers altındadır. Yanlış `import 'package:blind_social/core/localization/language_provider.dart';` yerine doğru olan `import 'package:blind_social/core/providers/localization_provider.dart';` kullanılmalıdır.
