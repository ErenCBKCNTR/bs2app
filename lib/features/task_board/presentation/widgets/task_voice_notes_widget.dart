                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('Kaydediliyor: ${_formatDuration(_recordDuration)} / 05:00', style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.red)),
                      ],
                    ),
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
                      onPressed: _stopRecording,
                      child: const Text('Durdur', style: TextStyle(color: Colors.white)),
                    )
                  ],
                ),
              )
